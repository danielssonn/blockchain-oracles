    ...
    <div className="py-6 pl-6 rounded-l-lg bg-white/60 ">
      ...
      <div className="rounded-lg border border-[#3926AD] flex items-center mb-3">
        ...
        <div className="w-3/5 pb-3">
          <div className="p-4">
            <p className="font-normal mb-1">Hi Alex,</p>
            <p className="font-normal">Thanks for all your efforts on the CIBC Costco Mastercard initiative!  I appreciate your hard work ensuring every Costco client got their new CIBC Mastercard on time. You will go on to achieve big things. <FaRegSmile className="inline"/></p>
            <p className="font-normal mt-3">Wen</p>
          </div>
        </div>
        ...
        <div className="w-2/5 my-8 px-4 border-l border-[#3926AD]/40">
          ...
          {/* CTA */}
          <button onClick={() => props.stakeeChanger({ value: 'Wen', label: 'Wen MacBay' })} className="text font-semibold bg-[#5841f0] px-4 py-2 rounded-lg text-white">Stake On Wen!</button>
        </div>
      </div>
    </div>
